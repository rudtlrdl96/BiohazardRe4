...
#include "Actor/Monster/Animation/Notify/BAnimNotify_MonsterAttackOn.h"

#include "GameFramework/Character.h"
#include "BiohazardRe4.h"
#include "Actor/Monster/Interface/BMonsterStateInterface.h"

void UBAnimNotify_MonsterAttackOn::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
