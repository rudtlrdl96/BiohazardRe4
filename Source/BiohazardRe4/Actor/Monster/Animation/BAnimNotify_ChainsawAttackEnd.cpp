...
void UBAnimNotify_ChainsawAttackEnd::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	if (MeshComp == nullptr)
	{
		LOG_FATAL(TEXT("MeshComp == nullptr : UBAnimNotify_ChainsawAttackEnd::Notify - Parameter"));
		return;
	}
	...
	{
		LOG_FATAL(TEXT("MeshCharacter is Nullptr : UBAnimNotify_ChainsawAttackEnd::Notify - 30"));
		return;
	}
